...
/// Project:	FMI 3D (2013)
/// File:		09233 OpenGL polygons
/// Topic:		9 Graphical Primitives
/// Slide:		22
///	About:		OpenGL polygons
///
/// History:
///		2013.07.12/MD	Initial implementation
...
{
	/// Open window
	if( !openWindow3D( "OpenGL polygons" ) ) return 1;
