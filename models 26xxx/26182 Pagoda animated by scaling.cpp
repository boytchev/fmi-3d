...
/// Project:	FMI 3D (2013)
/// File:		26182 Pagoda animated by scaling.cpp
/// Topic:		26 Deformations
/// Slide:		18
///	About:		A pagoda animated by scaling of floors
///
/// History:
...
{
	/// Open window
	if( !openWindow3D( "Pagodas animated by scaling" ) ) return 1;
	changeGround();
	changeGround();
	changeBrightness();
