...
/// Project:	FMI 3D (2013)
/// File:		19302 Matrix homogeneous scaling.cpp
/// Topic:		19 Matrices
/// Slide:		30
///	About:		Homogeneous scaling with matrix
///
/// History:
...
matrix scalingHomoMatrix( double s )
{
	return
	{
		{ 1, 0, 0,  0  },
...
{
	/// Open window
	if( !openWindow3D( "Matrix homogeneous scaling" ) ) return 1;
	noGround();
