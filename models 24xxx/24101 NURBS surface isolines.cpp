...
/// Project:	FMI 3D (2013)
/// File:		24101 NURBS surface isolines.cpp
/// Topic:		24 Surfaces
/// Slide:		07
///	About:		Example of isolines on a NURBS surface
///
/// History:
...
{
	/// Open window
	if( !openWindow3D( "NURBS surface isolines" ) ) return 1;
	changeGround();
	changeGround();
	changeGround();
	...
	texId = loadTexture("24101 Texture.jpg");
