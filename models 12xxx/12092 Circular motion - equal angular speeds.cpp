...
/// Project:	FMI 3D (2013)
/// File:		12092 Circular motion - equal angular speeds
/// Topic:		12 Trajectories
/// Slide:		9
///	About:		Circular motion - equal angular speeds, different linera speeds
///
/// History:
...
int main()
{
	...
	/// Open window
	if( !openWindow3D( "Circular motion: equal angular speeds" ) ) return 1;
	changeGround();
	changeGround();
	changeGround();
