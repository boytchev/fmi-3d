...
/// Project:	FMI 3D (2013)
/// File:		25091 Dominant speed.cpp
/// Topic:		25 Skeletons
/// Slide:		09
///	About:		Role of dominant speed
///
/// History:
...
void speedOn()
{
	...
	switch( mode/2 )
	{
		case 0: speedL = 2; speedR = 200.5; break;
		case 1: speedL = 4.5; speedR = 23.44; break;
		case 2: speedL=0.2; speedR = 300; break;
	}
	cloud = 0;
}
...
{
	/// Open window
	if( !openWindow3D( "Dominant speed" ) ) return 1;
	//changeBrightness();
	changeGround();
	changeGround();
	changeGround();
	...
	/// Add buttons
	sB = new Button2D( "buttons/button_start.png",GLFW_KEY_SPACE,speedOn,0,3 );
