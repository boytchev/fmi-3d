...
/// Project:	FMI 3D (2013)
/// File:		30492 Bitmask logic mixing.cpp
/// Topic:		30 Films
/// Slide:		49
///	About:		Mixing frames with bitmask logic operations
///
/// History:
...
{
	/// Open window
	if( !openWindow3D( "Bitmask logic mixing" ) ) return 1;
	changeBrightness();
	changeGround();
	changeGround();
	changeGround();
