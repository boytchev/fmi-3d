...
/// Project:	FMI 3D (2013)
/// File:		23461 C1 continuity.cpp
/// Topic:		23 Curves
///	Slide:		46
///	About:		C1 continuity of quadric Bezier curves (n=2)
///
/// History:
...
{
	/// Open window
	if( !openWindow2D( "C1 continuity of Bezier curves" ) ) return 1;
	noGround();
	...
	while( isRunning() )
	{
		P[2]->setCenter((P[1]->getCenter()).add((P[3]->getCenter())).mul(0.5));
	}
