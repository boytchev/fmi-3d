...
/// Project:	FMI 3D (2013)
/// File:		13422 Water waves vertical motion.cpp
/// Topic:		13 Physics
/// Slide:		42
///	About:		A grid of nodes for water waves moving vertically
///
/// History:
...
{
	/// Open window
	if( !openWindow3D( "Water waves vertical motion" ) ) return 1;
	changeGround();
	changeGround();
	changeGround();
