...
/// Project:	FMI 3D (2013)
/// File:		08261 Bresenham algorithm.cpp
/// Topic:		08 Rasterisation
/// Slide:		26
///	About:		Bresenham algorithm for rasterisation of segment
///
/// History:
...
int main()
{
	...
	/// Open window
	if( !openWindow3D( "Bresenham algorithm" ) ) return 1;
	changeBrightness();
	changeGround();
	changeGround();
	changeGround();
