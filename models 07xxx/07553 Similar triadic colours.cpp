...
/// Project:	FMI 3D (2013)
/// File:		07553 Similar triadic colours.cpp
/// Topic:		07 Colours
/// Slide:		55
///	About:		Three similar colours
///
/// History:
...
{
	/// Open window
	if( !openWindow2D( "Similar triadic colours" ) ) return 1;
	changeBrightness();
	changeGround();
	changeGround();
	...
	while( isRunning() )
	{
		double angle1 = atan2( obj[2]->getCenter().y,obj[2]->getCenter().x )*180/M_PI;
