...
/// Project:	FMI 3D (2013)
/// File:		07541 Triadic colours.cpp
/// Topic:		07 Colours
/// Slide:		54
///	About:		Selection of tree reqularily-distributed colours
///
/// History:
...
{
	/// Open window
	if( !openWindow2D( "Triadic colours" ) ) return 1;
	changeBrightness();
	changeGround();
	changeGround();
