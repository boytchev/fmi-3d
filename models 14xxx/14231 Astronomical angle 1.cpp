...
/// Project:	FMI 3D (2013)
/// File:		14231 Astronomical angle 1.cpp
/// Topic:		14 Orientation
/// Slide:		23
///	About:		14231 Astronomical angle 1
///
/// History:
...
{
	/// Open window
	if( !openWindow3D( "Astronomical angle 1" ) ) return 1;
	changeBrightness();
	changeGround();
	changeGround();
	...
	while( isRunning() )
	{
		...
		r1->rotateLocal(45*sin(t)-45,{0,1,0});

		h1->identity();
		h1->rotateLocal(90,{1,0,0});
		h1->translateLocal({0,4,0});
		h1->rotateLocal(45-45*sin(t),{0,0,1});
