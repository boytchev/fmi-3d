...
/// Project:	FMI 3D (2013)
/// File:		14401 Aeronavigation - Pitch.cpp
/// Topic:		14 Orientation
/// Slide:		40
///	About:		Aeronavigation: Pitch
///
/// History:
	...
	for(int i=-30; i<=30; i+=5)
		{
			...
			glVertex3d(r*cos(a),-m,r*sin(a)+4);
			glVertex3d(r*cos(a),+m,r*sin(a)+4);
		}
		glEnd();
	glDepthMask(GL_TRUE);
...
{
	/// Open window
	if( !openWindow3D( "Aeronavigation: Pitch" ) ) return 1;
	...
	while( isRunning() )
	{
		...
		plane->rotateLocal( 30*cos(2*t), {0,1,0} );
	}
	return 0;
}
