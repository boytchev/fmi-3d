...
/// Project:	FMI 3D (2013)
/// File:		14242 Astronomical angle 3.cpp
/// Topic:		14 Orientation
/// Slide:		24
///	About:		Astronomical angle 3
///
/// History:
...
{
	/// Open window
	if( !openWindow3D( "Astronomical angle 3" ) ) return 1;
	changeBrightness();
	changeGround();
	changeGround();
